		...
		<div class="reader-body">
			<div class="reader-header">
				...
				<div class="operator">
					<el-space>
						<i
								:class="isLike ? 'icon-xihuan' : 'icon-xihuan1'"
								:style="{ color: isLike ? 'red' : '' }"
								class="iconfont icon"
								@click="like">
						</i>
						<span :style="{ color: isLike ? 'red' : '' }">{{ likeCount }}</span>
					</el-space>
					<el-space>
						<i
								:class="isNotLike ? 'icon-badreview-full' : 'icon-buxihuan'"
								class="iconfont icon"
								@click="unLike">
						</i>
...
function unLike() {
	...
	patch(url, commentId, {
		...
		isNotLike.value = !isNotLike.value;
